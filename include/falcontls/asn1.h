...
extern FC_ASN1_VALUE *FC_ASN1_item_d2i(FC_ASN1_VALUE **val, const uint8_t **in,
                            long len, const FC_ASN1_ITEM *it);
extern int FC_ASN1_item_i2d(FC_ASN1_VALUE *val, uint8_t **out,
                            const FC_ASN1_ITEM *it);
extern int FC_ASN1_item_ndef_i2d(FC_ASN1_VALUE *val, uint8_t **out,
                            const FC_ASN1_ITEM *it);
